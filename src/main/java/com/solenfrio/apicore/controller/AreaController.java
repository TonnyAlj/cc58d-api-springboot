...
import com.solenfrio.apicore.service.AreaService;
...
public class AreaController {
   ...
   @GetMapping("{id}")
    ...
    public ResponseEntity<Object> getAll() {
        ...
        return ResponseEntity.status(200).body(areaService.getAll());
    }

    @PostMapping
    public Area create(@RequestBody @Valid AreaDTO dto) {
